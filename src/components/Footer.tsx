...
import { DESKTOP, MOBILE, TABLET, useDeviceDetection } from '../lib/hooks'
...
const MobileFooter = () => {
    ...
    return (
      <motion.div style={{ y }} className={cn('w-full pb-0 overflow-hidden items-end block')}>
            ...
            <div className="flex flex-wrap pb-[calc(var(--section-padding)/2)] relative">
              <div className="flex-colf">
                <div className="absolute right-0 bottom-[calc(var(--gap-padding)*1.5)] w-arrow">
                  <motion.svg style={{ scale: 2 }} width="14" height="14" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
            ...
            <div className="pb-[calc(var(--section-padding)*0.475)] flex flex-wrap relative">
              <div className="flex-col flex-colf w-full">
                ...
                <div className="max-w-fit absolute -top-20 right-[7vw] z-20">
                  <FramerBtn key={'linkedin-24'} keystr={'linkedin-24'} coordx={x} background="#455CE9" label="Get in touch" type="rounded" />
                </div>
              </div>
            </div>
            <div className="row pb-0 lg:pb-11 w-full md:w-auto mt-[3vh] lg:mt-0 h-[20vh]">
...
export default function Footer() {
  ...
  if (device == DESKTOP) {
    return (
      <motion.div style={{ y }} ref={container} className={cn('w-full pb-0 overflow-hidden items-end block')}>
        <footer className="section bg-dark overflow-clip">
          <div className={cn('flex flex-col medium')}>
            <div className="flex flex-wrap pb-[calc(var(--section-padding)/2)] relative">
              <div className="flex-colf">
                <div className="absolute right-0 bottom-[calc(var(--gap-padding)*1.5)] w-arrow">
                  <motion.svg style={{ rotate, scale: 2 }} width="14" height="14" viewBox="0 0 9 9" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path
                      d="M8 8.5C8.27614 8.5 8.5 8.27614 8.5 8L8.5 3.5C8.5 3.22386 8.27614 3 8 3C7.72386 3 7.5 3.22386 7.5 3.5V7.5H3.5C3.22386 7.5 3 7.72386 3 8C3 8.27614 3.22386 8.5 3.5 8.5L8 8.5ZM0.646447 1.35355L7.64645 8.35355L8.35355 7.64645L1.35355 0.646447L0.646447 1.35355Z"
                      fill="white"
                    />
        ...
        {device == DESKTOP && <div className="overlay overlay-gradient"></div>}
      </motion.div>
    )
  }
}
